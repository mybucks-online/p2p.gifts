...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "p2p.gifts | Crypto Gift Cards",
        short_name: "p2p.gifts",
        description:
        ...
        screenshots: [
          {
            ...
            type: "image/png",
            form_factor: "wide",
            label: "Gift card wizard on desktop",
          },
          {
            ...
            type: "image/png",
            form_factor: "narrow",
            label: "Gift card wizard on mobile",
          },
        ],
      },
      workbox: {
  ...
  resolve: {
    alias: {
      "@p2p-gifts": path.resolve(__dirname, "./src"),
    },
  },
  optimizeDeps: {
