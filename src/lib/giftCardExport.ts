...
async function waitForFonts(cardElement: HTMLElement): Promise<void> {
...
export function getGiftQrImageSettings(qrSize: number = GIFT_QR_EXPORT_SIZE) {
...
export function preloadGiftQrLogo(): Promise<void> {
...
export function waitForQrCanvasPaint(): Promise<void> {
  return new Promise((resolve) => {
