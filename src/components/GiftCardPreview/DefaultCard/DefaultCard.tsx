...
import type { GiftCardProps } from "@p2p-gifts/types/card";

const CardRoot = styled.div<{ $from: string; $to: string }>`
...
const DefaultCard = forwardRef<HTMLDivElement, GiftCardProps>(
  function DefaultCard({ theme, note = "", giftingLink }, ref) {
